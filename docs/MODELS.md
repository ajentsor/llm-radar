...
**Summary:** 85 OpenAI models, 8 Anthropic models, and 26 Google Gemini models are currently accessible via API, including latest GPT-5.2, Claude 4.5, and Gemini 3 series.
