...
**Summary:** 85 OpenAI models, 9 Anthropic models, and 27 Google models are currently accessible via API, including advanced GPT-5 series, Claude 4.x series, and Gemini 3.x series.
...
| `gpt-5.3-codex` | chat | active | text |
...
| Model ID | Type | Status | Input Modalities |
|----------|------|--------|------------------|
| `claude-sonnet-4-6` | chat | active | text |
...
[API Documentation](https://ai.google.dev/docs) | [Website](https://cloud.google.com)

| Model ID | Type | Status | Input Modalities |
|----------|------|--------|------------------|
| `models/gemini-3-pro-preview` | chat | preview | text |
| `models/gemini-3-flash-preview` | chat | preview | text |
| `models/gemini-3.1-pro-preview` | chat | preview | text |
| `models/gemini-3-pro-image-preview` | chat | preview | text, image |
| `models/gemini-3.1-flash-image-preview` | chat | preview | text, image |
