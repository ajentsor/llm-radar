...
**Summary:** 93 models available across OpenAI (85 models), Anthropic (8 models), and Google (31 models)
...
**Note:** Models with multimodal input support (text + image/audio) are indicated in the Input Modalities column.